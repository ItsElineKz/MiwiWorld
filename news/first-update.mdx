...
Ahora la **Network** se encuentra en listas de servidores, puedes encontrarla en: [Minecraft Servers](https://minecraftservers.org/server/668667). Se está trabajando para poder agregar la característica para votar al servidor y obtener recompensas.
